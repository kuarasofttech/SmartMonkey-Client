...
export function answersBlock(a, connections) {
  ...
  return [
    ...
    '',
    'The questions in "First, a short interview" below have already been answered in the SmartMonkey app. **Do not ask me any of them, and do not ask me anything else** — I am not at a terminal to reply, and nobody will answer. Use these answers and go straight on:',
    '',
    ...lines,
    '',
    ...
    '',
    '**Open questions:** search the code, tests and docs first. Only put something in `openQuestions[]` when neither the repo nor these answers settle it — never for something a default above already covers, and never as a way to avoid looking.',
    '',
    '---',
    '',
  ].join('\n');
